    ...
    <section>
        ...
        <div className="flex justify-center mt-8">
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
                ...
                <ServiceCard icon={pc} title="Web Development" description="We help develop company websites to be more professional and attractive" className='drop-shadow-green-600/25'/>
